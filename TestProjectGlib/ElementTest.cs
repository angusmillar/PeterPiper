...
namespace TestProjectGlib
{
  ...
  public class ElementTest
  {
    ...
    public void ElementConstructorTest()
    {
      ...
      Assert.AreEqual(4, target.CountRepeat, "A test for Element Constructor");
    }
    ...
    public void ElementConstructorTest1()
    {
      ...
      Assert.AreEqual(4, target.CountRepeat, "A test for Element Constructor 1");
    }
    ...
    public void ElementConstructorTest2()
    {
      ...
      Assert.AreEqual(0, target.CountRepeat, "A test for Element Constructor 2");
    }
    ...
    ///</summary>
    [TestMethod()]
    public void ElementConstructorTest3()
    {
      MessageDelimiters CustomDelimiters = null; 
      Element target = new Element(CustomDelimiters);
      Assert.AreSame(CustomDelimiters, target.Delimiters, "A test for Element Constructor 3");
    }
    ...
    public void AddTest()
    {
      ...
      Assert.AreEqual(5, target.CountRepeat, "A test for Add");
    }
    ...
    public void CloneTest()
    {
      ...
      Assert.AreEqual(null, actual._Index, "A test for Clone");
      Assert.AreEqual(null, actual._Parent, "A test for Clone");
      Assert.AreEqual(true, actual._Temporary, "A test for Clone");      
    }
