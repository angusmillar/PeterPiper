  ...
  public class HL7StreamWriter 
  {
    ...
    private void _Write(string OneMessage, HL7OutputStyles eHL7OutputStyle)
    {
      using (StreamWriter _Writer = new StreamWriter(_Path, _Append))
      {
        ...
        {
          string[] SpltMessagSegments = OneMessage.Split(Glib.Hl7.V2.Support.Standard.Delimiters.SegmentTerminator);
    ...
    public void Write(Glib.Hl7.V2.Model.Message oHL7, HL7OutputStyles eHL7OutputStyle)
    {
      _Write(oHL7.AsStringRaw, eHL7OutputStyle);
    }
    public void Write(List<Glib.Hl7.V2.Model.Message> oMessageList, HL7OutputStyles eHL7OutputStyle)
    {
