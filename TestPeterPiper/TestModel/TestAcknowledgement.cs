...
namespace TestPeterPiper.TestModel
{
  ...
  public class TestAcknowledgement
  {
    ...
    public void GenerateAcknowledgementMessageTest()
    {
      ...
      oMsg.Append("MSH|^~\\&|SUPERLIS|TRAIN|EGATE-Atomic^prjSUPERLISIn|EMR|20140527095657||ORU^R01^ORU_R01|0000000000000000010D|P|2.3.1|||||||en"); oMsg.Append("\r");
      ...
      oAck.Append("MSH|^~\\&|EGATE-Atomic^prjSUPERLISIn|EMR|SUPERLIS|TRAIN|20140527095657||ACK|0000000000000000010D|P|2.3.1"); oAck.Append("\r");
