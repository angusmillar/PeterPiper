...
public interface IEscapeData
{
    ...
    /// </summary>
    Support.Standard.EscapeType EscapeType { get; }

    /// <summary>
    /// Returns the first character of the escape sequence 
    /// </summary>
    string EscapeTypeCharacter { get; }
    
    /// <summary>
    /// Returns the first character of the escape sequence 
    /// </summary>
    [Obsolete("Incorrect property name spelling mistake, please use 'EscapeTypeCharacter'")]
