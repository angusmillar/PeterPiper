...
{
    /// <summary>
    /// Get the content as a decoded string (human-readable).     
    /// </summary>
    ...
    /// </summary>
    Support.Content.ContentType ContentType { get; set; }

    /// <summary>
    /// Returns the Metadata about the escape, useful for custom escapes.
