...
internal class Content : ContentBase, IContent
{
  ...
  public Support.Content.ContentType ContentType
  {
    get
    {
      ...
      {
        throw new PeterPiperException($"Unknown ModelSupport.ContentTypeInternal of :{_InternalContentType.ToString()}");
      }
    }
    set
    {
      ...
      {
        throw new PeterPiperException($"Unknown Support.Content.ContentType of :{value.ToString()}");
      }
    }
  }
    ...
    : base(CustomDelimiters)
  {
    ...
    _InternalContentType = ModelSupport.ContentTypeInternal.Escape;
    _EscapeMetaData = new EscapeData(EscapeType, String.Empty);
    _Data = Support.Standard.Escapes.ResolveEscapeCharacter(EscapeType).ToString();
    SetParent();
  }
