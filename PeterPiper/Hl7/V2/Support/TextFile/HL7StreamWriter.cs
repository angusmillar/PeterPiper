...
namespace PeterPiper.Hl7.V2.Support.TextFile
{
  public class HL7StreamWriter 
  {
    ...
    public void Write(PeterPiper.Hl7.V2.Model.Message oHL7, HL7OutputStyles eHL7OutputStyle)
    {
      _Write(oHL7.AsStringRaw, eHL7OutputStyle);
    }
    public void Write(List<PeterPiper.Hl7.V2.Model.Message> oMessageList, HL7OutputStyles eHL7OutputStyle)
    {
